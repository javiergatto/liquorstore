...
import { patchIntentPattern } from '../actions/modules';


class IntentPatternEditForm extends Component {
...
const mapDispatchToProps = dispatch => {
    return{
        onSubmit: (data) => dispatch(patchIntentPattern(data))
    }
}

export default connect(null, mapDispatchToProps)(IntentPatternEditForm);
